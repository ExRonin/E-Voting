        ...
        <div class="navbar navbar-default" role="navigation">
            ...
            <div class="navbar-inner">
                ...
                <ul class="collapse navbar-collapse nav navbar-nav top-menu">
                    <li><a href="<?php echo base_url('index.php'); ?>"><i class="glyphicon glyphicon-globe"></i> Lihat Kandidat</a></li>
                </ul>
                    ...
                    <div class="sidebar-nav">
                        <div class="nav-canvas">
                            ...
                            <ul class="nav nav-pills nav-stacked main-menu">
                                ...
                                <li class="nav-header hidden-md">DATA KANDIDAT </li>
                                ...
                                <li><a class="ajax-link" href="<?php echo base_url('index.php/siswa/form'); ?>"><i class="glyphicon glyphicon-list-alt"></i><span> Tambah DPT Massal</span></a></li>
