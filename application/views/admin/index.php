...
<div class="box">
    <div class="box-inner">
        ...
        <div class="box-content">
            ...
            ?>
            <label class="label-control"> Judul Pemilihan </label>
            <?php
            $form_attribute = array(
                'type'      => 'text',
                'class'     => 'form-control',
                'name'      => 'judul',
                'value'     => $loaddata['judul']
            );
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Tentang E-Voting</h2>
