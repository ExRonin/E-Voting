...
<?php if (!isset($no_visible_elements) || !$no_visible_elements) { ?>
    ...
    <footer class="row">
        <p class="col-md-4 col-sm-6 col-xs-6 copyright">&copy; <?php echo date('Y') ?><a href="" target="_blank"> </a></p>
        <p class="col-md-4 col-sm-6 col-xs-6 copyright text-center"><b><a href="" target="_blank">E-Voting v.0.1.0</a></b></p>
